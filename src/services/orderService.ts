...
export const getAllOrders = async (restaurantId?: string): Promise<OrderResponse> => {
  try {
    ...
    // Récupérer les articles de commande seulement pour les commandes récentes
    for (const order of formattedOrders) {
      // Ne récupérer les items que pour les commandes de moins de 2 jours
      ...
      // Les commandes de plus de 2 jours garderont items = []
    }
