...
const Commander = () => {
  ...
  const categories = [
    // ... keep existing categories data array
  ];
  ...
  const renderMobileCategoryTabs = () => (
    <div className="mb-8">
  ...
  const renderDesktopCategoryTabs = () => (
  ...
  return (
    <div className="container mx-auto py-24 px-4">
      ...
      >
        ...
        {isMobile && renderMobileCategoryTabs()}

        <div className="flex flex-col md:flex-row gap-6">
          {!isMobile && renderDesktopCategoryTabs()}
