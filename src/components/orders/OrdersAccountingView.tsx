...
const OrdersAccountingView = ({ 
  ...
  const printOrder = async (order: Order) => {
    // 🆕 NOUVELLE FONCTIONNALITÉ: Envoi à l'imprimante Epson via serveur OVH
    const { sendOrderToPrinter } = await import('@/services/printerService');
    
    console.log('🖨️ Envoi commande à l\'imprimante Epson:', order.id);
    
    toast({
      title: "Envoi en cours...",
      description: "Envoi de la commande à l'imprimante",
    });
  ...
  // Fonction obsolète - supprimée car l'impression se fait maintenant via le serveur OVH
