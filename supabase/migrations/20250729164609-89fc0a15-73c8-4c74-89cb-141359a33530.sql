-- Ajouter le rôle super_administrateur au type user_role
ALTER TYPE user_role ADD VALUE 'super_administrateur';

-- Créer une table pour gérer les permissions des administrateurs
...
-- D'abord, récupérer les IDs des utilisateurs à partir de leurs emails
DO $$
DECLARE
  anais_id uuid;
  clweb_id uuid;
